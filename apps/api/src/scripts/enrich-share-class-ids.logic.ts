...
import { detectAssetTypeFromMorningstarUrl } from '../assets/resolver/utils/www-morningstar-quote';
...
function localShareClassId(asset: BackfillAsset): string | null {
  return (
...
/**
 * Decide what the backfill should do before hitting Morningstar.
 * Stocks and garbage IDs must not be scraped.
 */
export function planShareClassBackfill(asset: BackfillAsset): BackfillPlan {
...
export function formatSkipSummary(
  ...
  return (Object.entries(skipped) as [BackfillSkipReason, number][])
